        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="row">
                    ...
                    $query = $pdo->prepare("SELECT property.*, user.uname, user.utype, user.uimage FROM property JOIN user ON property.uid = user.uid WHERE state = :state");
                    // $sql = "SELECT property.*, user.uname, user.utype, user.uimage 
                    //                         FROM property 
                    //                         JOIN user ON property.uid = user.uid  where state = ";
            ...
            <div class="col-lg-4">
                ...
                <div class="sidebar-widget mt-5">
                    ...
                    <ul class="property_list_widget">
                        <?php 
                        $query = $pdo->prepare("SELECT * FROM property ORDER BY date DESC LIMIT 6");
                        $query->execute();
                        $recent_properties = $query->fetchAll(PDO::FETCH_ASSOC);
